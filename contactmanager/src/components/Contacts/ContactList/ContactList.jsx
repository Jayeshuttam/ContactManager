                    ...
                    <div className="grid">
                        <div className="row">
                            <div className="col">
                                ...
                                <p className='fst-italic'> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente esse illo aliquam nemo veritatis iste praesentium quam aperiam, modi doloremque odit labore assumenda dolorem laudantium temporibus tenetur totam quas sit.</p>
                            </div>
                        </div>
                        <div className="row">
